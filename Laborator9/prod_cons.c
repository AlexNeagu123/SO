/*
  Program: demo_data-race1_prod+cons_v1_non-synced.c (Varianta nesincronizată !)
  ...
  partenerului său, consumatorul, prin scriere într-o mapare anonimă în memorie, într-un buffer de tip write-once.
  ...
  de la partenerul său, producătorul, prin citirea lor dintr-o mapare anonimă în memorie, dintr-un buffer în care le-a scris producătorul.
*/
