...
int main(int argc, char *argv[])
{
    ...
    if (pid == 0)
    {
        ...
        execlp("ls", "ls", "-l", "-i", dirname, NULL); // aici nu e dat prin cale absoluta/relativa deci se cauta in folderele din PATH
        // execl("/bin/ls","ls","-l","-i",dirname,NULL); // aici ii dam exact calea absoluta/relativa
