...
int main()
{
    ...
    // dup2 -- primeste doi parametri oldD, newD. Nu mai gaseste cel mai mic descriptor neutilizat ci pur simplu ii dam noi un descriptor
    // newD. fluxul din newD se redirecteaza spre oldD! Putem inchide oldD dupa! Toate apelurile spre newD vor fi directate spre fisierul 
    // asociat lui oldD!  
    ...
    // /dev/tty -- "pathul" asociat terminalului respectiv intrarii standard stdiout!
    // practic pathul stdoutului daca il privim ca un fisier
