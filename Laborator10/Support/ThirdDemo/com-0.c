...
int main()
{
    ...
    // dup simplu primeste un singur parametru - descriptorul de fisier si creaza o 
    // copie a acestuia utilizand cel mai mic fileDescriptor neutilizat in acel moment pentru
    // noul descriptor. 
    // Acum si vechiul si nou descriptor se refera la ACELASI fisier!
    // Daca se gaseste descriptorul 1 (cel asociat iesirii stdout), practic ce se intampla este ca 
    // se directeaza fluxul stdout in fisierul pe care l-am dat ca parametru in dup!
