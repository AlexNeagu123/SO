...
int main(int argc, char** argv)
{
    ...
    if(-1 == fdR)
    {
        perror("Eroare la deschiderea neblocanta a capatului de citire al canalului");  
        exit(3);
    }
    ...
    *  Însă, mai jos, am nevoie de descriptori diferiți pentru cele două capete, ca să le pot închide individual, și pentru a avea citire neblocantă (!!!) */
    ...
    if(-1 == fdRW)
    {
        perror("Eroare la redeschiderea canalului (simultan la ambele capete ale canalului)");  
        exit(9);
    }
